...
define('cwf-picker', ['cwf-core', 'cwf-widget', 'css!cwf-picker-css.css'], function(cwf) { 
	...
	cwf.widget.PickerWidget = cwf.widget.InputboxWidget.extend({
		...
		showText: function(v) {
			this.toggleClass('cwf_picker-hidetext', !v);
			this._updateSelection();
		},
	...
	cwf.widget.PickerItem = cwf.widget.UIWidget.extend({
	...
	cwf.widget.Colorpicker = cwf.widget.PickerWidget.extend({
		...
		useDefaults: function() {
			...
			_.forEach(cwf.widget.DEFAULT_PALETTE, function(value) {
				cwf.widget.create(self, {wclass: 'Colorpickeritem'}, {value: value});
			});
		},
	...
	cwf.widget.Colorpickeritem = cwf.widget.PickerItem.extend({
	...
	cwf.widget.Imagepickeritem = cwf.widget.PickerItem.extend({
