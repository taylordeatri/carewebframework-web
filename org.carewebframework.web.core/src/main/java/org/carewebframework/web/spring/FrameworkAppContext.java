...
public class FrameworkAppContext extends XmlWebApplicationContext implements ResourceCache.IResourceCacheAware {
     ...
     */
    public static FrameworkAppContext getAppContext(Page page) {
        return page == null ? null : (FrameworkAppContext) page.getAttribute(APP_CONTEXT_ATTRIB);
    }
    ...
    public FrameworkAppContext(Page page, boolean testConfig, String... locations) {
        ...
        if (page != null) {
            page.setAttribute(APP_CONTEXT_ATTRIB, this);
    ...
    public void close() {
        ...
        if (page != null) {
            page.removeAttribute(APP_CONTEXT_ATTRIB);
        }
    }
